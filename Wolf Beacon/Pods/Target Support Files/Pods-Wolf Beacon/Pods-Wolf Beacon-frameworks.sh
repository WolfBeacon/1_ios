...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Wolf Beacon/PermissionScope.framework"
  install_framework "Pods-Wolf Beacon/ReachabilitySwift.framework"
  install_framework "Pods-Wolf Beacon/SDWebImage.framework"
  install_framework "Pods-Wolf Beacon/SVProgressHUD.framework"
